...
![[DIR.ADM.A.7-img1-pg1.png]]

**ANALISTA DOS TRIBUNAIS** LUCAS MARTINS DIREITO ADMINISTRATIVO AULA 7
...
- Por isso devem existir instrumentos para fiscalizar essa atuação pautada na legalidade
...
-Controle dos órgãos dentro da Administração (dentro do âmbito do próprio ente; da mesma PJ)

**b) Controle Finalístico**

-Controle entre entes diferentes

-Controle por vinculação/ tutela administrativa/ supervisão ministerial
...
-Realizado no mesmo Poder (não se estende a outro poder do Estado)

  - Controle interno interior: ocorre dentro do mesmo Poder E do mesmo Ente

  - Controle interno exterior: ocorre no mesmo Poder, mas entre entes diferentes
...
-ex. Legislativo no Executivo

-Atente-se que mesmo sendo entes diferentes (União e uma autarquia), se for no mesmo Poder, não será externo

- Há parte da doutrina que aduz que o controle externo é aquele que ocorre entre Poderes diferentes ou entre entes diferentes

-O controle externo decorre do sistema de freios e contrapesos: somente haverá o controle de um Poder no outro nas hipóteses previstas ORIGINARIAMENTE na CF/88 (não pode ser alterado nem por Emenda)

- Fundamentado no sistema de freios e contrapesos

**c) controle social / popular**

- Controle feito pela própria população

- Parte da doutrina entende que esse controle está inserido no controle externo
...
-Controla a conformidade do ato com a norma jurídica

-Pode gerar a anulação ou convalidação (se vício sanável)

-Controle de legitimidade/juridicidade: está de acordo com a ordem jurídica

**b) Controle de Mérito**

-Controla a conveniência e oportunidade do ato
...
-Não parte do Estado a iniciativa para começar o controle (inicia-se a partir de terceiros)

  - ex. servidor denuncia outro para instaurar PAD

**b) Controle de Ofício**

-Parte do próprio Estado a iniciativa de começar o controle (inicia-se a partir do controlador)
...
-Realizado durante a prática/formação do ato

  - Controle simultâneo

  - ex. controle de fiscal de contrato durante a obra
...
-Órgão da própria Administração realizando o controle (independentemente do poder)
...
-Órgão do Legislativo realizando o controle sobre outro Poder

**c) Controle Judicial**

-Órgão do Judiciário realizando o controle sobre outro Poder obs. Atento para o controle do Judiciário ou Legislativo de seus próprios atos administrativos

- Nesse caso não se trata de controle judicial ou legislativo
...
- Trata-se de controle interno/administrativo

- O controle judicial é controle externo
...
4.2. Instrumentos de controle administrativo
 ...
 ![InkWriting](<Ink/Writing/2026.8.24 - 14.29pm.svg>) [Edit Writing](https://youtu.be/2arL1jh8ihA?type=inkWriting&aspectRatio=2.051)
...
- o direito diz respeito à coletividade

**c) Pedido de reconsideração**   
- controlador e controlado se confundem

**d) Recurso administrativo**    
- controlador está acima do controlado

**e) Revisão**    
- sanção + fatos novos (art. 65 da Lei 9784/99) – não se admite a reforma em prejuízo
...
1.1. Servidão Administrativa
  ...
  - Recairá sempre sobre _imóveis_ determinados e deverá ser registrada em cartório para que produza efeito erga omnes. 
  - Trata-se da utilização de um bem imóvel de um particular para a _prestação de um determinado serviço_ _público_ (exemplo: utilização do subsolo de uma fazenda para instalação de tubos para circulação de gás). A servidão tem _caráter perpétuo_ (prazo indeterminado) e atinge o _caráter exclusivo_ da propriedade (já que o proprietário irá dividir a utilização do bem com o Estado).
