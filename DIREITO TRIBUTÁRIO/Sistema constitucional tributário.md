---
tags: [Vavilov, DIREITO_TRIBUTÁRIO, Sistema_constitucional_tributário]
data: 2026-03-31
---
...
> [!INFO] Contexto
> Visão geral e conceito base sobre **Sistema constitucional tributário**.
...
> [!SUCCESS]- Questão 1 | #resposta #questão #DIREITO_TRIBUTÁRIO #Sistema_constitucional_tributário
> *[[Banca]]* *[[Ano]]* *[[Cargo]]*
...
```mermaid
graph TD
    Raiz[Sistema constitucional tributário] --> Ramo1(Conceito A)
